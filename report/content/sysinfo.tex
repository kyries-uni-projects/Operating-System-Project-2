...
\begin{enumerate}
    \item Định nghĩa cấu trúc \texttt{sysinfo}.
    \item Cung cấp syscall \texttt{sysinfo} để thu thập và trả về thông tin hệ thống.
    \item Triển khai các hàm hỗ trợ để đếm bộ nhớ trống và số tiến trình.
    \item Viết chương trình test để kiểm tra.
\end{enumerate}
